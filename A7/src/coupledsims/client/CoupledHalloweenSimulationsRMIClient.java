...
public class CoupledHalloweenSimulationsRMIClient extends AnAbstractSimulationParametersBean implements Client, RMIClient {
    ...
    private RMIServer serverRMIProxy;
    ...
    protected void init(String[] args) {
        try {
            ...
            this.serverRMIProxy.registerRMIClients(RMIClient.class.getName());
    ...
    protected void sendProposalViaRMI(Object aProposal, String stateName) {
        try {
            ...
            switch(stateName) {
                case CommunicationStateNames.COMMAND:
                    ...
                    break;
                case CommunicationStateNames.IPC_MECHANISM:
                    IPCMechanism ipcMechanism = (IPCMechanism) aProposal;
                    this.serverRMIProxy.receiveIPCMechanismViaRMI(ipcMechanism, this);
                    break;
                case CommunicationStateNames.BROADCAST_MODE:
                    boolean isAtomicBroadcast = (boolean) aProposal;
                    this.serverRMIProxy.receiveBroadcastStateViaRMI(isAtomicBroadcast, this);
                    break;
            }
        } catch (RemoteException ex) {
            ex.printStackTrace();
    ...
    protected void sendBroadcastStateViaRMI(boolean isAtomicBroadcast) {
        this.sendProposalViaRMI(isAtomicBroadcast, CommunicationStateNames.BROADCAST_MODE);
    }
    ...
    public synchronized void setAtomicBroadcast(Boolean newValue) {
        ...
        this.commandProcessor.setConnectedToSimulation(!newValue);
        this.sendBroadcastStateViaRMI(newValue);
    }
